        ...
        <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="bg-[#ffffff] dark:bg-[#232b3b] rounded-xl p-8 md:p-12 border border-[#e2e8f0] dark:border-[#334155]">
                <article className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <p>
                        Welcome to HackFusion ("we," "our," or "us"). We are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform, including our website and services (collectively, the "Service"). By using the Service, you agree to the collection and use of information in accordance with this policy.
                    </p>
                    ...
                    <p>
                        ...
                        <a href="mailto:contact@hackfusion.dev" className="text-[#f97316]">
                            contact@hackfusion.dev
                        </a>.
                    </p>
                </article>
            </div>

...
import { HackFusionLogo } from "../components"
  ...
  return (
    <div className="max-w-5xl mx-auto py-8">
      <header className="text-center mb-16 relative">
        <HackFusionLogo className="absolute inset-0 w-full h-full text-slate-200/30 dark:text-slate-800/40 -z-10 transform scale-150" />
        ...
        <div className="flex justify-center items-center">
          <div className="bg-[#ffffff] dark:bg-[#232b3b] p-8 rounded-xl border border-[#e2e8f0] dark:border-[#334155]">
            ...
            <p className="text-[#475569] dark:text-[#94a3b8] leading-relaxed">
              ...
              of solution spoilers. HackFusion was built to solve these challenges by providing a one-stop platform
      ...
      <section className="bg-[#ffffff] dark:bg-[#232b3b] rounded-xl p-8 md:p-12 border border-[#e2e8f0] dark:border-[#334155] mb-10">
        ...
        <div className="max-w-md mx-auto bg-[#f8fafc] dark:bg-[#1a2332] rounded-lg p-6 text-center shadow-lg">
          <img
            src="https://media.licdn.com/dms/image/v2/D4E03AQHurIg6o36qmA/profile-displayphoto-scale_400_400/B4EZhctyLeHEAg-/0/1753902164043?e=1758758400&v=beta&t=GM7knDIsgCzy0ydBQbxcBs5vU8FV-q8B9LX2yntrrtk"
            alt="Mohd Farhan"
            className="w-24 h-24 rounded-full mx-auto mb-4 border-4 border-[#f97316]"
          />
          <h3 className="text-2xl font-bold text-[#1e293b] dark:text-[#e2e8f0]">Mohd Farhan</h3>
          <p className="text-[#f97316] font-semibold mb-3">Full Stack Developer</p>
          <p className="text-[#475569] dark:text-[#94a3b8] mb-4">
            The mind and muscle behind HackFusion, Farhan is a passionate developer dedicated to creating tools that
            empower other coders. He built HackFusion to solve the common hurdles faced by learners in the tech space.
          </p>
          <div className="flex justify-center space-x-4">
            <a href="https://github.com/FarhanAnsari124" target="_blank" aria-label="Github Profile" className="text-slate-500 hover:text-[#f97316]">
              <Github size={24} />
            </a>
            <a href="https://www.linkedin.com/in/mohd-farhan-ansari-596101314" target="_blank" aria-label="LinkedIn Profile" className="text-slate-500 hover:text-[#f97316]">
              <Linkedin size={24} />
            </a>
          </div>
        </div>

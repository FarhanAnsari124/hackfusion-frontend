...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', href: 'https://github.com/FarhanAnsari124' },
    { name: 'Twitter', href: 'https://x.com/FarhanMoha13858' },
    { name: 'LinkedIn', href: 'https://www.linkedin.com/in/mohd-farhan-ansari-596101314' },
  ];
    ...
    <footer className="bg-slate-50 dark:bg-gray-800 border-t border-slate-200 dark:border-gray-700 transition-colors duration-300">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <div className="flex items-center">
              <HackFusionLogo size={6} className="" />
              <span className="font-bold text-xl text-slate-800 dark:text-white ml-2">HackFusion</span>
            </div>
        ...
        <div className="mt-12 border-t border-slate-200 dark:border-gray-700 pt-8 text-center">
          <p className="text-base text-slate-500 dark:text-gray-400">&copy; {new Date().getFullYear()} HackFusion. All rights reserved.Made With ❤️ By Farhan</p>
        </div>
      </div>
    </footer>
  );
